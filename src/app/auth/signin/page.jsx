...
const Signin = () => {
  return (
    <div className="flex items-center justify-center min-h-[89vh] dark:bg-black bg-white font-mono relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-md w-full mx-auto rounded-xl p-8 bg-gradient-to-br from-slate-300 to-gray-400 dark:from-gray-900 dark:to-black  border border-slate-400 dark:border-gray-700 backdrop-blur-lg">
